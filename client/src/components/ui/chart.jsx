...
// Theme: Clean modern colors for OBE
const THEMES = {
  light: "",
  dark: ".dark",
}
      ...
      <div
        ...
        style={{
          ...
          ...Object.entries(config).reduce((acc, [key, value]) => {
            acc[`--color-${key}`] = value.color || "inherit"
            return acc
          }, {}),
        }}
        {...props}
...
function getPayloadConfigFromCustom(config, item, key) {
  if (typeof item !== "object" || item === null) {
    return undefined
  }

  const configLabelKey = item[key] || item.dataKey || key
